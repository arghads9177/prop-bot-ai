...
from workflow.graph import create_proposal_workflow
...
# Dummy input (Freelancer + JD only for now)
initial_state = AppState(
    freelancer_profile="John is an AI freelancer skilled in LangChain and Python.",
    job_description="We want to build a LangChain-based proposal generator with PDF export."
)
...
print(final_state.generated_proposal)
